...
<body class="min-h-screen flex items-center justify-center">
    <div class="w-full max-w-lg bg-[#F0F0F0] rounded-3xl p-10 shadow-2xl border border-slate-300">
        ...
        <h1 class="text-2xl font-bold text-center mb-6 text-[#1B3C53]">Edit Absensi Pegawai</h1>
        ...
        <form action="{{ route('attendance.update', $attendance->id) }}" method="POST" class="space-y-5">
            ...
            <div>
                ...
                <input type="date" id="tanggal" name="tanggal" 
                       ...
                       class="mt-1 block w-full rounded-lg border border-slate-300 p-2 focus:ring-1 focus:ring-[#456882]  focus:outline-none" required>
